...
public interface BaseRepository<T> {
	...
	public List<Object> executeSqlByMapParams(String sql, Integer page, Integer fetchSize, Map<String, Object> params);
	public int countSqlByMapParams(String sql, Map<String, Object> params);
