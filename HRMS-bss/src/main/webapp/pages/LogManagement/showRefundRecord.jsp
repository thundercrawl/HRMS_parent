...
<div>
		<ul class="breadcrumb">
			<li><a href="javaScipt:void(0);">日志管理/个人账单/退款记录</a></li>
		</ul>
</div>
...
<div class="row">
	<div class="box col-md-12">
		<div class="box-inner">
                 ...
                 <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                  ...
                  <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                   ...
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                    ...
                    <input type="text" class="form-control" placeholder="订单编号" id="orderNo"  name="orderNo" value="" >
                   </div>
                  <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                    <span class="input-group-addon">退款起始时间</span>
                   <input type="text" class="form-control reDatetimepicker" placeholder="退款起始时间" id="submitTime" name="submitTime" />
                   </div>
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                    <span class="input-group-addon">退款结束时间</span>
                   <input type="text" class="form-control reDatetimepicker" placeholder="退款结束时间"  id="endTime" name="endTime" />
                   </div>            
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                   <span class="input-group-addon">退款方式</span>
		 ...
		 <a href="javaScript:void(0);" class="btn btn-primary" id="Refund" onclick="findRefund()">查询</a>
              	</div>
                  
                  </form>
					<div id="PersonalBills3" style="margin-top: 8px;">
						<jsp:include page="refundRecord.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>
