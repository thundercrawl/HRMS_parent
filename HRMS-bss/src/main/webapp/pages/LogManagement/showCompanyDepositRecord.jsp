...
<div>
		<ul class="breadcrumb">
			<li><a href="javaScipt:void(0);">公司交易记录</a></li>
		</ul>
</div>
<div class="row">
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-content" style="overflow-x: scroll;min-height: 320px;">
				...
				<input hidden="true" id="isCom" name="isCom" value="2">
				 <input hidden="true" id="userName" name="userName">
				  <input hidden="true" id="userPhone" name="userPhone">
                ...
                <input type="hidden" id="formParam" value>
					<div id="PersonalBills12" style="margin-top: 8px;">
						<jsp:include page="companyRecord.jsp"></jsp:include>
					</div>
				</div>
