...
<table class="table table-striped table-bordered bootstrap-datatable dataTable responsive" id="DayBusinessRecord">
	<thead>
		<tr>
			<th>时间</th>
			<th>公司名称</th>
...
<jsp:include page="../common/paginator.jsp">
	<jsp:param value="filter/PersonalBills/findDayBusinessRecord?userName=${userName}&userPhone=${userPhone}&companyName=${companyName }&sTime=${sTime}&eime=${eTime}" name="url" />
	<jsp:param value="DayBusinessRecord" name="loadCmp"/>
</jsp:include>
