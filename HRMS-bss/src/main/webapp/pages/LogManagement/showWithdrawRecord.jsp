...
<div>
		<ul class="breadcrumb">
			<li><a href="javaScipt:void(0);">日志管理/个人账单/提现记录</a></li>
		</ul>
</div>
...
<div class="row">
	<div class="box col-md-12">
		<div class="box-inner">
				...
				<form action="">
                 ...
                 <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                  ...
                  <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                   ...
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                    <span class="input-group-addon">提现起始时间</span>
                   <input type="text" class="form-control reDatetimepicker" placeholder="提现起始时间" id="submitTime" name="submitTime" />
                   </div>
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                    <span class="input-group-addon">提现结束时间</span>
                   <input type="text" class="form-control reDatetimepicker" placeholder="提现结束时间"  id="endTime" name="endTime" />
                   </div>            
                   <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
		 ...
		 <a href="javaScript:void(0);" class="btn btn-primary" id="Withdraw" onclick="findWithdraw()">查询</a>
               </div>
                 </form>
					<div id="PersonalBills2" style="margin-top: 8px;">
						<jsp:include page="withdrawRecord.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>
