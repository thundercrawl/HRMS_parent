...
<div>
		<ul class="breadcrumb">
			<li><a href="javaScipt:void(0);">日志管理/业务记录/日业务记录</a></li>
		</ul>
</div>
				...
				<form action="">
                 ...
                 <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                  ...
                  <div class="input-group col-md-3" style="margin: 2px 0;display: inline-table;">
                   ...
                   <input type="text" class="form-control reDatetimepicker" placeholder="选择查询时间" id="submitTime" name="submitTime" />
                   </div>
                   <div class="input-group col-md-1 colLee" style="display:inline-block;">
		<a href="javaScript:void(0);" class="btn btn-primary" id="" onclick="findDayBusinessRecord()">查询</a>
               </div>
                 
                </form>
					<div id="DayBusinessRecord" style="margin-top: 8px;">
						<jsp:include page="DayBusinessRecord.jsp"></jsp:include>
					</div>
				</div>
			</div>
		</div>
