...
<div>
	<ul class="breadcrumb">
		<li><a href="javaScipt:void(0);">请假、出差审核管理</a></li>
	</ul>
</div>
<div class="row">
						...
						<div>
							<form id="forid">
								<div class="input-group col-md-3"
									...
									<span class="input-group-addon">审批流水号</span> <input type="text"
										class="form-control" placeholder="审批流水号" id="leaveCode" />
								</div>
								<div class="input-group col-md-1 colLee">
									<a href="javaScript:void(0);" class="btn btn-primary"
										id="forApproveSearch">查询</a>
								</div>
							</form>
							<div id="exportCom"></div>
							<input type="hidden" value="" id="companySearchCondition">
							<div id="tid" style="margin-top: 8px;">
								<jsp:include page="approveTable.jsp"></jsp:include>
							</div>
						</div>
					</div>
				</div>
...
<script src="js/hrms-leave/approveInfo.js"></script>