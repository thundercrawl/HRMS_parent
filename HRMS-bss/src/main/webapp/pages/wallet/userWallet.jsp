...
<div class="class_item_fg">
	...
	<jsp:include page="../common/paginator.jsp">
		<jsp:param value="filter/wallet/userall" name="url" />
		<jsp:param value="user_wallet_info" name="loadCmp" />
		<jsp:param value="user_wallet_ip" name="formParam" />
	</jsp:include>
</div>
<script src="js/walletitem/userWalletfirst.js"></script>