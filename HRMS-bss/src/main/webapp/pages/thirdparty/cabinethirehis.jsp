...
<jsp:include page="../common/paginator.jsp">
	<jsp:param
		value="filter/thirdparty/cabinethirehis/showcabinethirehis?code=${code}&cabinetdetailid=${cabinetdetailid}&username=${username}&companyname=${companyname}&projectid=${projectid}&fromstarttime=${fromstarttime}&tostarttime=${tostarttime}"
		name="url" />
