			...
			<div class="box-content"
				...
				<div id="transfer-alert2" style="display: none;">
					<form class="user-form user-form1 user-info" id="companyId1"
						...
						<div>
							<label for="companyEmail">用户职位<font style='color:red'>*</font>：</label> <input type="text"
								id="companyEmailAdd" />
						</div>
						<div>
							<label for="companyPhone">手机号：</label> <input type="text"
								id="companyPhoneAdd" /> <span id="phonespan"></span>
						</div>
						<div>
						</div>
						<div>
							<label for="companyIntroduction">用户介绍：</label> <input type="text"
						...
						<div>
							<label for="companyImg">用户头像：</label> <input type="file"
							...
							<form id="forid">
								...
								<div class="input-group col-md-3"
									...
									<span class="input-group-addon">姓名</span> <input type="text"
										class="form-control" placeholder="姓名" id="companyName"
										name="companyName">
								</div>
								<div class="input-group col-md-3"
									style="margin: 2px 0; display: inline-table;">
									<span class="input-group-addon">职位</span> <input type="text"
										class="form-control" placeholder="职位" id="companyAddress"
										name="companyAddress">
								</div>
								<div class="input-group col-md-3"
									style="margin: 2px 0; display: inline-table;">
									<span class="input-group-addon">部门</span> <input type="text"
										class="form-control" placeholder="部门" id="companyAddress"
										name="companyAddress">
								</div>
								<div class="input-group col-md-3"
									style="margin: 2px 0; display: inline-table;">
