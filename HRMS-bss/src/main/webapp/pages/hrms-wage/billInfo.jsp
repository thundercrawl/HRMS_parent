...
<div>
	<ul class="breadcrumb">
		<li><a href="javaScipt:void(0);">员工薪资</a></li>
	</ul>
</div>
<div class="row">
							...
							<form id="forid">
								<div class="input-group col-md-3"
									...
									<span class="input-group-addon">用户名称</span> <input type="text"
										class="form-control" placeholder="用户名称" id="userNameInput" value="${searchParam.userName}"/>
								</div>
								<div class="input-group col-md-3"
									 style="margin: 2px 0; display: inline-table;">
									<span class="input-group-addon">用户号码</span>
									<input type="text" class="form-control" placeholder="用户号码" id="userPhoneInput" value="${searchParam.userPhone}"/>
								</div>
								<div class="input-group col-md-3"
									 style="margin: 2px 0; display: inline-table;">
									<span class="input-group-addon">部门名称</span> <input type="text"
																					 class="form-control" placeholder="部门名称" id="orgNameInput" value="${searchParam.orgName}"/>
								</div>
								<div class="input-group col-md-3"
									 style="margin: 2px 0; display: inline-table;">
...
<script src="js/hrms-wage/billInfo.js"></script>